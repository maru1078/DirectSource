...
SimpleMesh::SimpleMesh(ID3D11Device * device, ID3D11DeviceContext * deviceContext)
	: m_device{ device }
...
void SimpleMesh::load(const std::string & fileName)
{
...
void SimpleMesh::draw(SimpleMesh::Shader & shader) const
{
...
ID3D11Buffer * SimpleMesh::createBuffer(UINT bind, UINT size, const void * data)
{
