...
void Mesh::load(const std::string & fileName)
{
	...
	{
		unsigned int verticesxSize = 0;
		file.read(reinterpret_cast<char*>(&verticesxSize), sizeof(verticesxSize));
		vertices.resize(verticesxSize);
		file.read(reinterpret_cast<char*>(vertices.data()), sizeof(Vertex) * verticesxSize);
	}
